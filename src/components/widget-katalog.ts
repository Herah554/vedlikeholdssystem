...
export const MALER: Mal[] = [
  ...
  },
  {
    id: "delelager",
    navn: "Delelager",
    beskrivelse: "Beholdning, delebehov og det som må bestilles.",
    oppsett: [
      { id: "d1", type: "delebehov", w: 3, h: 2, x: 0, y: 0 },
      { id: "d2", type: "lav-beholdning", w: 3, h: 2, x: 3, y: 0 },
      { id: "d3", type: "kostnad-hittil", w: 6, h: 2, x: 6, y: 0 },
      { id: "d4", type: "siste-ordrer", w: 6, h: 6, x: 0, y: 2 },
      { id: "d5", type: "ordrer-per-status", w: 6, h: 4, x: 6, y: 2 },
    ],
  },
  {
    id: "kompakt",
  ...
  },
  {
    id: "min-dag",
    navn: "Min dag",
    beskrivelse: "Startsiden din: egne jobber, snarveier og det som haster.",
    oppsett: [
      { id: "m1", type: "mine-jobber", w: 6, h: 6, x: 0, y: 0 },
      { id: "m2", type: "hurtiglenker", w: 3, h: 6, x: 6, y: 0 },
      { id: "m3", type: "kritiske-ordrer", w: 3, h: 2, x: 9, y: 0 },
      { id: "m4", type: "delebehov", w: 3, h: 2, x: 9, y: 2 },
      { id: "m5", type: "forfalt-pm", w: 3, h: 2, x: 9, y: 4 },
    ],
  },
  {
    id: "innkjop",
    navn: "Innkjøp",
    beskrivelse: "Hva teknikerne venter på, og hva det koster.",
    oppsett: [
      { id: "i1", type: "delebehov", w: 3, h: 2, x: 0, y: 0 },
      { id: "i2", type: "lav-beholdning", w: 3, h: 2, x: 3, y: 0 },
      { id: "i3", type: "kostnad-hittil", w: 3, h: 2, x: 6, y: 0 },
      { id: "i4", type: "apne-ordrer", w: 3, h: 2, x: 9, y: 0 },
      { id: "i5", type: "kostnad-per-maaned", w: 12, h: 5, x: 0, y: 2 },
      { id: "i6", type: "siste-ordrer", w: 12, h: 4, x: 0, y: 7 },
    ],
  },
  {
    id: "analyse",
    navn: "Analyse",
    beskrivelse: "Bare diagrammer. Til gjennomgangen på slutten av måneden.",
    oppsett: [
      { id: "a1", type: "kostnad-per-maaned", w: 6, h: 5, x: 0, y: 0 },
      { id: "a2", type: "ordrer-per-status", w: 6, h: 5, x: 6, y: 0 },
      { id: "a3", type: "nedetid-per-utstyr", w: 6, h: 5, x: 0, y: 5 },
      { id: "a4", type: "pm-etterlevelse", w: 3, h: 2, x: 6, y: 5 },
      { id: "a5", type: "nedetid-30", w: 3, h: 2, x: 9, y: 5 },
      { id: "a6", type: "kostnad-hittil", w: 6, h: 3, x: 6, y: 7 },
    ],
  },
  {
    id: "etterlevelse",
    navn: "Frister og bevis",
    beskrivelse: "Kalibrering som går ut, og forebyggende som forfaller.",
    oppsett: [
      { id: "e1", type: "utloper-snart", w: 6, h: 5, x: 0, y: 0 },
      { id: "e2", type: "forfalt-pm", w: 3, h: 2, x: 6, y: 0 },
      { id: "e3", type: "pm-etterlevelse", w: 3, h: 2, x: 9, y: 0 },
      { id: "e4", type: "apne-ordrer", w: 3, h: 2, x: 6, y: 2 },
      { id: "e5", type: "kritiske-ordrer", w: 3, h: 2, x: 9, y: 2 },
      { id: "e6", type: "siste-ordrer", w: 6, h: 4, x: 6, y: 4 },
    ],
  },
];
